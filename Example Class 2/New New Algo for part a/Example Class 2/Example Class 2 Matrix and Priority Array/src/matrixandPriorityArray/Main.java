...
public class Main {
  ...
  public static void main(String[] args) 
    ...
    ArrayList<Integer> nodeAlrConnectedtoSource = new ArrayList<Integer> (size); 
    ArrayList<Integer> nodeNotConenctedtoSource = new ArrayList<Integer> (size); 
    ...
    while(true){
      ...
      int left_value = arrayNumbers[rand.nextInt(nodeAlrConnectedtoSource.size()-1)];
      int right_value = arrayNumbers2[rand.nextInt(nodeNotConenctedtoSource.size()-1)];
