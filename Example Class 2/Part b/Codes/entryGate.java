...
class entryGate {
  ...
  public static void main(String arg[]) throws IOException {
    ...
    for (int n = 1; n <= (((size * size) - size) - (size - 1)); n = n + 100) {
      ...
      File csvFile = new File("BTimeanalysisFullGraphDifferent|E|.csv");
       ...
       * System.out.println("The shorted path from source node("
       * +source+") to other nodes:");
       * System.out.println("Node\t\t" + "Predecessor\t\t" + "Distance");
       * for (int i = 0; i < dpq.dist.length; i++)
       * System.out.println(" " + i + " \t\t     " + dpq.pi[i]+ " \t\t\t   " +
       * dpq.dist[i]);
       */
    }
  }
